...
```sh
sudo dpkg -i npmfilter_0.5.2_amd64.deb          # Debian, Ubuntu
sudo rpm -i npmfilter-0.5.2-1.x86_64.rpm        # Fedora, RHEL, openSUSE
```
...
```sh
cargo deb                                        # -> target/debian/npmfilter_0.5.2_amd64.deb
cargo generate-rpm                               # -> target/generate-rpm/npmfilter-0.5.2-1.x86_64.rpm
dpkg -c target/debian/npmfilter_0.5.2_amd64.deb  # inspect before installing
```
